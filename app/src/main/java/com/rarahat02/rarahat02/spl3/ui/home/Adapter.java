...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder>
{
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.ratingTextView.setText(String.valueOf(app.getDownloads() + " Songs Downloaded"));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v)
        {
            ...
            Intent intent = new Intent(v.getContext(), DetailArtistActivity.class);
            intent.putExtra("pic", mApps.get(getAdapterPosition()).getDrawable());
            intent.putExtra("name", mApps.get(getAdapterPosition()).getName());
            intent.putExtra("followers", Integer.toString(1000) + " Followers");
