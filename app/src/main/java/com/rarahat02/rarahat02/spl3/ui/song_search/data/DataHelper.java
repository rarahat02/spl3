package com.rarahat02.rarahat02.spl3.ui.song_search.data;
...
import com.rarahat02.rarahat02.spl3.ui.song_search.SongSearchActivity;
...
/*    private static List<ColorSuggestion> sColorSuggestions =
    ...
    public static void addValueListener()
    {
        ...
        mFirebaseDatabase = mFirebaseInstance.getReference("social/all_songs/0");
        ...
        ValueEventListener postListener = new ValueEventListener()
        {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                ...
                {
                    ColorSuggestion specimenDTO = child.getValue(ColorSuggestion.class);
                    sColorSuggestions.add(specimenDTO);

                }

                Log.v("songs", "onDataChange: " + sColorSuggestions.size());
                SongSearchActivity.progressBar.setVisibility(View.GONE);
