...
public class FeedItemAnimator extends DefaultItemAnimator {
    ...
    public boolean animateAdd(RecyclerView.ViewHolder viewHolder) {
        if (viewHolder.getItemViewType() == FeedAdapterForFirebase.VIEW_TYPE_DEFAULT) {
            if (viewHolder.getLayoutPosition() > lastAddAnimatedItem) {
                lastAddAnimatedItem++;
                runEnterAnimation((FeedAdapterForFirebase.CellFeedViewHolder) viewHolder);
                return false;
            }
        }
    ...
    private void runEnterAnimation(final FeedAdapterForFirebase.CellFeedViewHolder holder) {
    ...
    public boolean animateChange(@NonNull RecyclerView.ViewHolder oldHolder,
        ...
        if (preInfo instanceof FeedItemHolderInfo) {
            ...
            FeedAdapterForFirebase.CellFeedViewHolder holder = (FeedAdapterForFirebase.CellFeedViewHolder) newHolder;

            animateHeartButton(holder);
            updateLikesCounter(holder, holder.getFeedItem().likesCount);
            if (FeedAdapterForFirebase.ACTION_LIKE_IMAGE_CLICKED.equals(feedItemHolderInfo.updateAction)) {
    ...
    private void animateHeartButton(final FeedAdapterForFirebase.CellFeedViewHolder holder) {
    ...
    private void updateLikesCounter(FeedAdapterForFirebase.CellFeedViewHolder holder, int toValue) {
    ...
    private void animatePhotoLike(final FeedAdapterForFirebase.CellFeedViewHolder holder) {
/*        holder.vBgLike.setVisibility(View.VISIBLE);
    ...
    private void dispatchChangeFinishedIfAllAnimationsEnded(FeedAdapterForFirebase.CellFeedViewHolder holder) {
    ...
    private void resetLikeAnimationState(FeedAdapterForFirebase.CellFeedViewHolder holder) {
