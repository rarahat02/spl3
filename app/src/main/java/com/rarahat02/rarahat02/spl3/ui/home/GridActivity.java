...
public class GridActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.rarahat02.rubensousa.recyclerviewsnap.R.layout.activity_grid);
        mRecyclerView = (RecyclerView) findViewById(com.rarahat02.rubensousa.recyclerviewsnap.R.id.recyclerView);
