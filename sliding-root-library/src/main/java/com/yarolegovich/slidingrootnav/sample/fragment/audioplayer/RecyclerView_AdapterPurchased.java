 ...
 */
public class RecyclerView_AdapterPurchased extends RecyclerView.Adapter<ViewHolder>
{

    List<Audio> purchasedList = Collections.emptyList();
    Context context;


    public RecyclerView_AdapterPurchased(List<Audio> list, Context context)
    {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.title.setText(purchasedList.get(position).getTitle());

        Audio localItem = purchasedList.get(position);
...
class PurchasedViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
{
