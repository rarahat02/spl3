...
public class PlayerUnPurchasedFiles extends Fragment
{
    ...
    public static PlayerUnPurchasedFiles newInstance()
    {
        PlayerUnPurchasedFiles fragment = new PlayerUnPurchasedFiles();
        return fragment;
    }
                             ...
                             Bundle savedInstanceState)
    {
        ...
        frameLayout = (CoordinatorLayout) inflater.inflate(R.layout.player_un_purchased, container, false);
...
/*    @Override
    ...
    private int loadAudioForAsync()
    {
        ...
        ArrayList<HashMap<String,String>> songList = getAllUnpurchasedFiles(Environment.getExternalStorageDirectory() + "/AEncrypted Audio Files");
...
/*        if(songList != null)
    ...
    private ArrayList<HashMap<String,String>>  getAllUnpurchasedFiles(String rootPath)
    {
        ...
        try {
            ...
            for (File file : files)
            {
                if (file.isDirectory())
                {
                    if (getAllUnpurchasedFiles(file.getAbsolutePath()) != null)
                    {
                        fileList.addAll(getAllUnpurchasedFiles(file.getAbsolutePath()));
                    } else
                        break;

                }
                else if (file.getName().endsWith(".enc") /*|| file.getName().endsWith(".enc")*/)
                {
