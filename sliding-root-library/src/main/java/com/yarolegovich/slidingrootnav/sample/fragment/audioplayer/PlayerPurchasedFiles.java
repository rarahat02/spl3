...
public class PlayerPurchasedFiles extends Fragment
{
    ...
    ArrayList<Audio> purchasedAudioList;
    ...
    public static PlayerPurchasedFiles newInstance()
    {
        PlayerPurchasedFiles fragment = new PlayerPurchasedFiles();
        return fragment;
    }
                             ...
                             Bundle savedInstanceState)
    {
        ...
        frameLayout = (CoordinatorLayout) inflater.inflate(R.layout.player_purchased, container, false);
...
//                      //shouldShowRequestPermissionRationale will return true
    ...
    private void initRecyclerView()
    {
        ...
        if (purchasedAudioList != null && purchasedAudioList.size() > 0)
        {
            final RecyclerView recyclerView = (RecyclerView) frameLayout.findViewById(R.id.recyclerview);

            RecyclerView_AdapterPurchased adapter = new RecyclerView_AdapterPurchased(purchasedAudioList, getActivity().getApplication());
...
/*    @Override
    ...
    private void playAudio(int audioIndex) {
        ...
        if (!serviceBound) {
            ...
            storage.storeAudio(purchasedAudioList);
    ...
    private int loadAudioForAsync()
    {
        ...
        purchasedAudioList = new ArrayList<>();
...
/*        if(songList != null)
        ...
        if(songList != null)
        {
            ...
            for(int i=0; i <songList.size(); i++)
            {
                ...
                purchasedAudioList.add(new Audio(filePath, fileName, "", "", filePath));
